...
- Artwork CRUD (`POST/PATCH/DELETE /v1/studio/artworks`)
- Bulk image upload
- Studio analytics tab (aggregate from `events` table)
- Studio settings tab (bio, statement, links, commissioning, inquiry routing, visibility)
